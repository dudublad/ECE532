...
HD_PWD='E:/UofTCourse/ECE532/project/fpga_1_321/fpga_1_321/dm_server/demo_group.runs/design_1_fpga1_top_master_bram_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fpga1_top_master_bram_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fpga1_top_master_bram_0_0.tcl
