...
HD_PWD='E:/UofTCourse/ECE532/project/milestones/fpga1_axi_mb_integration/fpga1_top_tb/proj3/proj_p3.runs/design_1_fpga1_top_slv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fpga1_top_slv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fpga1_top_slv_0_0.tcl
